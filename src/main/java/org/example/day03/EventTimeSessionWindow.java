...
/**
 * 分组后再调用SessionWindow，每个组达到指定条数才会触发任务
 *
...
public class EventTimeSessionWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1640357980507,spark,3
        // 1640357981507, hadoop,2
        SingleOutputStreamOperator<String> lines = environment.socketTextStream("localhost", 8888)
                // 仅仅提取时间字段，不会改变数据
        ...
        sum.print();
        environment.execute("EventTimeSessionWindow");
    }
}
